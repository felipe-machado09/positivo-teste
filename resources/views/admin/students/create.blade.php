    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.students.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_nascimento') ? 'is-invalid' : '' }}" type="text" name="data_nascimento" id="data_nascimento" value="{{ old('data_nascimento') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tipo_endereco') ? 'is-invalid' : '' }}" name="tipo_endereco" id="tipo_endereco" required>
                    ...
                    @foreach(App\Models\Student::TIPO_ENDERECO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tipo_endereco', 'Escolha um Tipo') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rua') ? 'is-invalid' : '' }}" type="text" name="rua" id="rua" value="{{ old('rua', '') }}" required>
                @if($errors->has('rua'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero') ? 'is-invalid' : '' }}" type="text" name="numero" id="numero" value="{{ old('numero', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('serie') ? 'is-invalid' : '' }}" name="serie" id="serie" required>
                    ...
                    @foreach(App\Models\Student::SERIE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('serie', 'Escolha a Série') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('serie'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('segmento') ? 'is-invalid' : '' }}" name="segmento" id="segmento">
                    ...
                    @foreach(App\Models\Student::SEGMENTO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('segmento', 'Selecione o Segmento') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome_pai') ? 'is-invalid' : '' }}" type="text" name="nome_pai" id="nome_pai" value="{{ old('nome_pai', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome_mae') ? 'is-invalid' : '' }}" type="text" name="nome_mae" id="nome_mae" value="{{ old('nome_mae', '') }}" required>
