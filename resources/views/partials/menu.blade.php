        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('student_class_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.student-classes.index") }}" class="nav-link {{ request()->is("admin/student-classes") || request()->is("admin/student-classes/*") ? "active" : "" }}">
                ...
                @endcan
                @can('matricular_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.matriculars.index") }}" class="nav-link {{ request()->is("admin/matriculars") || request()->is("admin/matriculars/*") ? "active" : "" }}">
